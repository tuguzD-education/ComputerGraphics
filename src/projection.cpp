...
math::Frustum Projection::ToFrustum(
    const Transform& transform, const float width, const float height,
...
math::Matrix4x4 OrthographicProjection::ToMatrix(
    const float width, const float height, const float near_plane, const float far_plane) const {
...
math::Matrix4x4 PerspectiveProjection::ToMatrix(
    const float width, const float height, const float near_plane, const float far_plane) const {
