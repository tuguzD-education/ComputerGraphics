...
#ifndef INLINE_ALLOCATOR_INL_INCLUDED
#define INLINE_ALLOCATOR_INL_INCLUDED
...
template <std::size_t MaxStackSize>
InlineAllocator<MaxStackSize>::InlineAllocator(
    InlineAllocator &&other) noexcept : alloc_{}, size_{other.size_} {
    other.size_ = 0;
...
#endif  // INLINE_ALLOCATOR_INL_INCLUDED
