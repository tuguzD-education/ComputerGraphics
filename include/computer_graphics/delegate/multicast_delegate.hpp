...
#ifndef MULTICAST_DELEGATE_HPP_INCLUDED
#define MULTICAST_DELEGATE_HPP_INCLUDED
...
#define DECLARE_MULTICAST_DELEGATE(name, ...)                                   \
    using name = ::computer_graphics::delegate::MulticastDelegate<__VA_ARGS__>; \
    using name##Delegate = ::computer_graphics::delegate::MulticastDelegate<__VA_ARGS__>::DelegateT

#define DECLARE_EVENT(name, owner_type, ...)                                            \
    class name : public ::computer_graphics::delegate::MulticastDelegate<__VA_ARGS__> { \
      private:                                                                          \
        friend class owner_type;                                                        \
        using ::computer_graphics::delegate::MulticastDelegate::Broadcast;              \
        using ::computer_graphics::delegate::MulticastDelegate::RemoveAll;              \
        using ::computer_graphics::delegate::MulticastDelegate::Remove;                 \
    };
...
#endif  // MULTICAST_DELEGATE_HPP_INCLUDED
