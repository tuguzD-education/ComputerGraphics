...
void RotateAround(
    const Vector3 &position, const Vector3 &rotation_point,
    const Quaternion &rotate_by, Vector3 &result);
...
struct Triangle {
    ...
    [[nodiscard]] ContainmentType ContainedBy(
        math::Plane plane0, math::Plane plane1, math::Plane plane2,
