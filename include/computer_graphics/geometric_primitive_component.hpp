...
#ifndef GEOMETRIC_PRIMITIVE_COMPONENT_HPP_INCLUDED
#define GEOMETRIC_PRIMITIVE_COMPONENT_HPP_INCLUDED
...
using GeometricPrimitiveArguments =
    std::variant<CubeGeometricPrimitiveArguments, BoxGeometricPrimitiveArguments,
            SphereGeometricPrimitiveArguments, GeoSphereGeometricPrimitiveArguments,
            CylinderGeometricPrimitiveArguments, ConeGeometricPrimitiveArguments, TorusGeometricPrimitiveArguments,
...
#endif  // GEOMETRIC_PRIMITIVE_COMPONENT_HPP_INCLUDED
