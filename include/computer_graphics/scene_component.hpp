...
#ifndef SCENE_COMPONENT_HPP_INCLUDED
#define SCENE_COMPONENT_HPP_INCLUDED
...
class SceneComponent : public Component {
  public:
    ...
    [[nodiscard]] bool IsParentOf(
        const SceneComponent &scene_component,
...
#endif  // SCENE_COMPONENT_HPP_INCLUDED
