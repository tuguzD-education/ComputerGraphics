...
#ifndef MOON_HPP_INCLUDED
#define MOON_HPP_INCLUDED

#include <computer_graphics/collision.hpp>
#include <computer_graphics/geometric_primitive_component.hpp>

class Moon final : public computer_graphics::SceneComponent, public computer_graphics::Collision {
  public:
    explicit Moon(computer_graphics::Game &game, const Initializer &initializer = {});
