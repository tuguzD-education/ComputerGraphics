...
#ifndef SATURN_HPP_INCLUDED
#define SATURN_HPP_INCLUDED

#include <computer_graphics/collision.hpp>
#include <computer_graphics/geometric_primitive_component.hpp>

class Saturn final : public computer_graphics::SceneComponent, public computer_graphics::Collision {
  public:
    explicit Saturn(computer_graphics::Game &game, const Initializer &initializer = {});
