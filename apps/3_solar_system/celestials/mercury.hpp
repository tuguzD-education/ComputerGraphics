...
#ifndef MERCURY_HPP_INCLUDED
#define MERCURY_HPP_INCLUDED

#include <computer_graphics/collision.hpp>
#include <computer_graphics/geometric_primitive_component.hpp>

class Mercury final : public computer_graphics::SceneComponent, public computer_graphics::Collision {
  public:
    explicit Mercury(computer_graphics::Game &game, const Initializer &initializer = {});
