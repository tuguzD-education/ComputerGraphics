...
#ifndef URANUS_HPP_INCLUDED
#define URANUS_HPP_INCLUDED

#include <computer_graphics/collision.hpp>
#include <computer_graphics/geometric_primitive_component.hpp>

class Uranus final : public computer_graphics::SceneComponent, public computer_graphics::Collision {
  public:
    explicit Uranus(computer_graphics::Game &game, const Initializer &initializer = {});
